...
public class MessageCommandContainer {
    ...
    private static final String WHISPER_RECEIVER = "%s <gray><i>flüstert dir zu: <message>";
    ...
    private static int perform(CommandContext<CommandSourceStack> context) {
        ...
        String whisper_receiver_layout = String.format(WHISPER_RECEIVER, raspiPlayer.getColorName());
