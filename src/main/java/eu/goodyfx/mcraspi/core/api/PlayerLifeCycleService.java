...
import eu.goodyfx.mcraspi.core.database.RaspiAccount;
import eu.goodyfx.mcraspi.core.database.RaspiPlayer;
import eu.goodyfx.mcraspi.core.managers.LocationManager;
import eu.goodyfx.mcraspi.core.tasks.PlayTimeTask;
import eu.goodyfx.mcraspi.core.utils.PlayerJoinTasks;
import eu.goodyfx.mcraspi.core.utils.PlayerTime;
...
public class PlayerLifeCycleService {
    ...
    public void playerJoinHandler(@NonNull Player player) {
        ...
        if (!player.hasPlayedBefore()) {
            ...
            Location location = locationManager.get("spawn");
            if (location == null) {
                return;
            }
