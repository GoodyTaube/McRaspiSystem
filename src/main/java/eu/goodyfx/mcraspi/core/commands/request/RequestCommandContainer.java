package eu.goodyfx.mcraspi.core.commands.request;
...
import eu.goodyfx.mcraspi.core.database.RaspiUser;
...
public class RequestCommandContainer extends RaspiCommand {
    ...
    public RequestCommandContainer(McRaspiSystem plugin) {
        super(plugin);
    }

    public LiteralCommandNode<CommandSourceStack> command() {
        return Commands.literal(getName()).executes(RequestCommandContainer::executeCommandHelp)
