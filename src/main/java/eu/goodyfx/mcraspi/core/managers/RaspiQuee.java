package eu.goodyfx.mcraspi.core.managers;
...
import eu.goodyfx.mcraspi.core.utils.QueueContainer;
...
public class RaspiQuee {
    ...
    public void queue() {
        ...
        for (UUID per : playerContainer.keySet()) {
            ...
            RaspiPlayer raspiPlayer = Raspi.playerLifeCycleService().getRaspiPlayer(player.getPlayer());
            this.sendQueuePosition(raspiPlayer);
        }
    }
